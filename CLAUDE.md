...
- `window._usageLogged` 플래그로 중복 로그 방지
...
| 역할 | 이전 | 이후 |
|------|------|------|
| 페이지 배경 | #0a0a0a | #0d1117 |
| 카드/인풋 배경 | #141414 | #162032 |
| 드롭다운/패널 | #1a1a1a | #131c2e |
| 진행바/레이어 | #1c1c1c | #1a2840 |
| 보조 패널 | #111 | #111827 |
| 카드 테두리 | rgba(흰,0.07) | rgba(청,0.12) → 이후 제거 |
...
- `window._usageLogged` 플래그: 결과 수신 즉시 로그, goBack/beforeunload 중복 방지
